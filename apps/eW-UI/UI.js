  ...
  bar: function (data) {
    ...
    if (data.b) {
      ...
      // ---- slide mode ----
			...
			this.tmp += (this.val.reverce?-data.dx:data.dx);;
			this.tmp += data.dx;
			let lim = (300 / (this.val.up - this.val.dn)) | 0;
			let len = this.val.len || lim < 20 ? 20 : 70 < lim ? 70 : lim;
			...
			if (this.step) {
				...
				this.val.cur += (abs < 3 ? this.step : (abs * this.step / 1.3) | 0);
				this.tmp = 0;
